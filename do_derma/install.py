...
from do_derma.printing.note import ensure_assessment_print_format
...
def after_migrate() -> None:
	...
	try:
		ensure_assessment_print_format()
	except Exception:
		frappe.log_error(title="Derma assessment print format", message=frappe.get_traceback())
